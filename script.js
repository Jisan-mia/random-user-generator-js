...
function showUserName(){
    displayCurrentInfo ('user-name-div', 'user-email-div','user-phone-div', 'user-address-div');
}
function showUserEmail(){
    displayCurrentInfo ('user-email-div','user-phone-div', 'user-address-div', 'user-name-div');
}
function showUserPhone(){
    displayCurrentInfo ('user-phone-div','user-email-div', 'user-address-div', 'user-name-div');
}
function showUserLocation(){
    displayCurrentInfo ('user-address-div','user-phone-div','user-email-div', 'user-name-div');
}
